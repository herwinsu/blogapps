...
func App() *buffalo.App {
	if app == nil {
		app = buffalo.New(buffalo.Options{
			Env:          ENV,
			SessionName:  "_myprofile_session",
			SessionStore: sessions.NewCookieStore([]byte("1234567")),
		})

		// test := c.Session().Get(tokenKey)
		...
		// app.GET("/comments/create", CommentsCreate)
		// app.GET("/comments/edit", CommentsEdit)
		// app.GET("/comments/delete", CommentsDelete)
